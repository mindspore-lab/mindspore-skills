...
Reference convention: use current repository doc examples plus the final
requirements in `references/verification.md`.
...
Follow the current repository documentation patterns:
...
### Step 4: Confirm The Target Location
